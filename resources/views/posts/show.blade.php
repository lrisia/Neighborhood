...
{{--            <p class="bg-orange-100 text-gray-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded mr-2">
            ...
            <p class="bg-[#FFEA96] text-gray-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded mr-2">
                <span class="material-symbols-outlined">corporate_fare</span>
                &nbsp;ส่งเรื่องถึงองค์กร {{ $post->organization->name }}
            </p>
...
{{--                        <p class="inline-flex text-gray-400 text-sm">ความคิดเห็นโดย {{ $comment->user->name }}</p>--}}
                    ...
                    @can('delete', $comment)
                        ...
                        <button class="block app-button red" onclick="showDelete()" class="app-button red">ลบ</button>
                    @endcan
                                ...
                                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">แน่ใจหรือไม่ว่าจะลบความคิดเห็น การกระทำนี้ไม่สามารถย้อนกลับได้</h3>
                                            ...
                                            <button type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10" onclick="hideDelete()">ยกเลิก</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
